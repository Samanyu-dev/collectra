...
import { FREE_SET_LIMIT, FREE_SCAN_LIMIT_PER_WEEK } from "@/lib/billing/limits";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative bg-primary/5 border border-primary/30 rounded-3xl p-8 space-y-6">
          ...
          {pro ? (
            ...
            <UpgradeButton className="w-full flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-primary text-primary-foreground text-sm font-bold hover:opacity-90 transition-opacity disabled:opacity-50" />
          ) : (
            <Link
              href="/signup"
