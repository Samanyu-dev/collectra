              ...
              return (
                ...
                >
                  <Link href={`/cards/${card.id}`} className="block">
                    <div className={`card-frame relative aspect-[63/88] rounded-xl overflow-hidden bg-foreground/5 border transition-colors ${ownedQuantity > 0 ? 'border-primary/50' : 'border-foreground/5 group-hover:border-foreground/20'}`}>
